...
def CustomerBasketAdd(basket_id, item_id):
    cursor.execute("""
...
def findBasket(customerID):
    cursor.execute("SELECT BasketID FROM CustomerBasket WHERE CustomerID = ? AND Paid = FALSE;", (customerID,))
...
#This will reset the database to its default values
def resetDB():
    ...
    items = [
        (1, "Pop Album1", 2, "Description1", 15.00, 100),
        (2, "Pop Album2", 2, "Description2", 20.00, 100),
        (3, "Comedy Movie1", 4, "Description3", 9.50, 100),
        (4, "Rock Album2", 2, "Description4", 12.00, 100),
        (5, "Action Game3", 6, "Description5", 30.00, 100),
        (6, "Romance Show1", 3, "Description6", 40.00, 100),
        (7, "Country Album2", 2, "Description7", 5.00, 100),
        (9, "Action Game2", 5, "Description8", 35.00, 100),
        (11, "Action Game1", 6, "Description9", 15.00, 100),
        (12, "2D Game2", 5, "Description10", 60.00, 100),
        (13, "Country Album1", 2, "Description11", 50.00, 100),
        (14, "2D Game1", 6, "Description12", 25.00, 100),
        (15, "Game Show1", 4, "Description13", 150.00, 100),
        (16, "Jungle Album1", 1, "Description14", 80.00, 100),
        (17, "Educational Software1", 5, "Description15", 5.00, 100),
        (18, "Comedy Movie2", 4, "Description16", 9.50, 100),
        (19, "Jungle Album2", 2, "Description17", 8.99, 100),
        (20, "Action Game4", 6, "Description18", 30.00, 100),
        (21, "Animated Show1", 3, "Description19", 19.99, 0),
        (22, "Country Album3", 2, "Description20", 5.00, 100),
        (23, "Game Show2", 5, "Description21", 35.00, 100),
        (24, "Action Game5", 6, "Description22", 15.00, 100),
        (25, "2D Game3", 5, "Description23", 60.00, 100),
        (26, "Dubstep Album1", 2, "Description24", 5.00, 0),
        (27, "Collector's Game1", 6, "Description25", 999.50, 100),
        (28, "Animated Show2", 4, "Description26", 30.99, 100),
        (29, "Kpop Album1", 1, "Description27", 15.99, 100),
        (30, "Collector's Game2", 5, "Description28", 500.00, 100),
        (31, "Virtual  Album1", 2, "Description1", 15.00, 100),
        (32, "Kpop Album1", 2, "Description2", 20.00, 100),
        (33, "Fantasy  Movie1", 4, "Description3", 9.50, 0),
        (34, "Kpop Album2", 2, "Description4", 12.00, 100),
        (35, "Combat Game1", 6, "Description5", 30.00, 100)
    ]
    cursor.executemany("INSERT OR IGNORE INTO Item (ItemID, ItemName, ItemTypeID, ItemDescription, ItemPrice, Stock) VALUES (?, ?, ?, ?, ?, ?);", items)
